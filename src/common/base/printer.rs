...
impl Printer {
     ...
     */
    pub fn print(&self, buffer: &[u8], job_name: Option<&str>, options: PrintOptions) -> Result<(), &'static str> {
     ...
     */
    pub fn print_file(&self, file_path: &str, job_name: Option<&str>, options: PrintOptions) -> Result<(), &'static str> {
